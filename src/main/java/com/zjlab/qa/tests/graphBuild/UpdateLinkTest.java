...
public class UpdateLinkTest {
    private static final Logger log= LoggerFactory.getLogger(UpdateLinkTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_UPDATE_LINK);
    ...
    public void updateLink(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.updateLink(params);
