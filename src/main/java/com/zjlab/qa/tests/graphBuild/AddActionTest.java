...
public class AddActionTest {
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList(GraphBuildClientApi.CASE_FILE,GraphBuildClientApi.GRAPH_ADD_ACTION);
    ...
    public void addAction(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.addAction(params);
