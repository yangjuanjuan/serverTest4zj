...
public class UpdateEdgeTest {
    private static final Logger log= LoggerFactory.getLogger(UpdateEdgeTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_UPDATE_EDGE);
    ...
    public void updateEdge(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.updateEdge(params);
