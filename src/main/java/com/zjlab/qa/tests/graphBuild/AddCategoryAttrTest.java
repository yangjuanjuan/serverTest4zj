...
public class AddCategoryAttrTest {
    private static final Logger log= LoggerFactory.getLogger(AddCategoryAttrTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_ADD_CATEGORY_ATTR);
    ...
    public void addCategoryAttr(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.addCategoryAttr(params);
