...
public class UpdateCategoryTest {
    private static final Logger log= LoggerFactory.getLogger(UpdateCategoryTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_UPDATE_CATEGORY);
    ...
    public void updateCategory(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.updateCategory(params);
