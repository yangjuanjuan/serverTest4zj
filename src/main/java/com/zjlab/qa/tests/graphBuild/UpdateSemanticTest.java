...
public class UpdateSemanticTest {
    private static final Logger log= LoggerFactory.getLogger(UpdateSemanticTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_UPDATE_SEMANTIC);
    ...
    public void updateSemantic(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.updateSemantic(params);
