...
public class UpdateNodeTest {
    private static final Logger log= LoggerFactory.getLogger(UpdateNodeTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_UPDATE_NODE);
    ...
    public void updateNode(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.updateNode(params);
