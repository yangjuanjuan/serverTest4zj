...
public class AddCategoryTest {
    private static final Logger log= LoggerFactory.getLogger(AddCategoryTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_ADD_CATEGORY);
    ...
    public void addCategory(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.addCategory(params);
