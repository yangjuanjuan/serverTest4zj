...
public class UpdateFilterPipelineTest {
    ...
    public void setUp(){
        ...
        loadData = ReadExcelUtil.getExcelList(GraphAnalysisClientApi.CASE_FILE,GraphAnalysisClientApi.UPDATE_FILTER_PIPELINE);
...
*/
                ...
                id = JsonHandleUtil.getValueByJpath(addFilterPipelineJson, "result/id");
