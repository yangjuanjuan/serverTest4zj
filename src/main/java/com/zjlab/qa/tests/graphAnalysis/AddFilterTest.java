...
public class AddFilterTest {
    ...
    public void setUp(){
        ...
        loadData = ReadExcelUtil.getExcelList(GraphAnalysisClientApi.CASE_FILE,GraphAnalysisClientApi.ADD_FILTER);
    ...
    public void addFilter(Map<?,?> param) throws IOException, InterruptedException {
...
//创建过滤器流程
                ...
                filterPipelineId= JsonHandleUtil.getValueByJpath(filterPipelineJson, "result/id");
