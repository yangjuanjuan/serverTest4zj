...
public class QueryHeatMapTest {
    private static final Logger log= LoggerFactory.getLogger(QueryHeatMapTest.class);
    ...
    public void setUp(){
        ...
        loadData = ReadExcelUtil.getExcuteList("queryHeatMap.xlsx");

    }
    //    通过读取Excel获取测试数据Request Parameter
    @DataProvider
    public Object[][] queryHeatMapParams(){
    ...
    @Test(dataProvider = "queryHeatMapParams")
    public void queryHeatMap(Map<?,?> param) throws IOException, InterruptedException {
...
//载入数据需要一些时间
            ...
            CloseableHttpResponse re = graphAnalysisClient.queryHeatMap(params);
