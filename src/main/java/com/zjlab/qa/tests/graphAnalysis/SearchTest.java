...
public class SearchTest {
    ...
    public void setUp(){
        ...
        loadData = ReadExcelUtil.getExcelList(GraphAnalysisClientApi.CASE_FILE,GraphAnalysisClientApi.SEARCH);
    ...
    public void search(Map<?,?> param) throws IOException, InterruptedException {
...
//载入数据需要一些时间
            ...
            CloseableHttpResponse re = graphAnalysisClient.search(params);
