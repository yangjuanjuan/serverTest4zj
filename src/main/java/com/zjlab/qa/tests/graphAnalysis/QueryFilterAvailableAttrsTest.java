...
public class QueryFilterAvailableAttrsTest {
    private static final Logger log= LoggerFactory.getLogger(QueryFilterAvailableAttrsTest.class);
    ...
    public void setUp(){
        ...
        data = ReadExcelUtil.getExcuteList("queryFilterAvailableAttrs.xlsx");
...
//
            ...
            CloseableHttpResponse re = graphAnalysisClient.queryFilterAvailableAttrs(params);
