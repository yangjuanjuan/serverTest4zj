...
public class UpdateActionTest {
    private static final Logger log= LoggerFactory.getLogger(UpdateActionTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_UPDATE_ACTION);
    ...
    public void updateAction(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.updateAction(params);
