...
public class QueryClusterTest {
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_QUERY_CLUSTER);
    ...
    public void queryCluster(Map<?,?> param) throws IOException, InterruptedException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.queryCluster(params);
