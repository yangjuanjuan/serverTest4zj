...
public class QueryByIdTest {
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_QUERY_BY_ID);
    ...
    public void queryById(Map<?,?> param) throws IOException, InterruptedException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.queryById(params);
