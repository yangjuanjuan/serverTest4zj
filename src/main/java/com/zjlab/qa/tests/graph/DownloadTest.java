...
public class DownloadTest {
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_DOWNLOAD);
    ...
    public void download(Map<?,?> param) throws IOException, InterruptedException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.download(params);
            ...
            if(title.contains("成功")){
                Assert.assertTrue(res.contains("node"));
            }else{
