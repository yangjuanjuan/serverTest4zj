...
public class QueryByTaskIdTest {
    private static final Logger log= LoggerFactory.getLogger(QueryByTaskIdTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_QUERY_BY_TASK_ID);
    ...
    public void queryByTaskId(Map<?,?> param) throws IOException, InterruptedException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.queryByTaskId(params);
