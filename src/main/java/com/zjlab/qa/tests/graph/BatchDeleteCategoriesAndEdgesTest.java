...
public class BatchDeleteCategoriesAndEdgesTest {
    private static final Logger log= LoggerFactory.getLogger(BatchDeleteCategoriesAndEdgesTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_BATCH_DELETE_CATEGORIES_AND_EDGES);
    ...
    public void batchDeleteCategoriesAndEdges(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.batchDeleteCategoriesAndEdges(params);
            ...
            Assert.assertTrue(JsonHandleUtil.strCompare(res,expectResult,"code"),"实际结果："+res+"; 期望结果："+expectResult);
