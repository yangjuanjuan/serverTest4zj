...
public class SaveEdgeConfigureTest {
    private static final Logger log= LoggerFactory.getLogger(SaveEdgeConfigureTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_SAVE_EDGE_CONFIGURE);
    ...
    public void saveEdgeConfigure(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.saveEdgeConfigure(params);
