...
public class QueryActionTest {
    private static final Logger log= LoggerFactory.getLogger(QueryActionTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_QUERY_ACTION);
    ...
    public void queryAction(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.queryAction(params);
