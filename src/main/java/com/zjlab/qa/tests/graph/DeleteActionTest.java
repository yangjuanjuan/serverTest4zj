...
public class DeleteActionTest {
    private static final Logger log= LoggerFactory.getLogger(DeleteActionTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_DELETE_ACTION);
    ...
    public void deleteAction(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.deleteAction(params);
