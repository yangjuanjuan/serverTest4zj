...
public class QueryEdgeConfigureTest {
    private static final Logger log= LoggerFactory.getLogger(QueryEdgeConfigureTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_QUERY_EDGE_CONFIGURE);
    ...
    public void queryEdgeConfigure(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.queryEdgeConfigure(params);
