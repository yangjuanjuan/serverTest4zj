...
public class LoadGraphDataTest {
    private static final Logger log= LoggerFactory.getLogger(LoadGraphDataTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_LOAD_GRAPH_DATA);
    ...
    public void loadGraphData(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.loadGraphData(params);
