...
public class RemoveCategoryAttrTest {
    private static final Logger log= LoggerFactory.getLogger(RemoveCategoryAttrTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_REMOVE_CATEGORY_ATTR);
    ...
    public void removeCategoryAttr(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.removeCategoryAttr(params);
