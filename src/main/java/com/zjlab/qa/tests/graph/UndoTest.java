...
public class UndoTest {
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_UNDO);
    ...
    public void undo(Map<?,?> param) throws IOException, InterruptedException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.undo(params);
