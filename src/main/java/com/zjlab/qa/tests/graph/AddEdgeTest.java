...
public class AddEdgeTest {
    private static final Logger log= LoggerFactory.getLogger(AddEdgeTest.class);
    ...
    public void setUp(){
        ...
        caseParams = ReadExcelUtil.getExcelList("graphBuildCase.xlsx",GraphBuildClientApi.GRAPH_ADD_EDGE);
    ...
    public void addEdge(Map<?,?> param) throws IOException {
        ...
        if (isRun.equals("1")) {
            ...
            CloseableHttpResponse re = graphBuildClientApi.addEdge(params);
